...
namespace WcfServiceLibrary.DPService
{
    ...
    public class DynamicParamsService : IDynamicParamsService
    {
        ...
        public void AddDynamicParam(float value, DateTime period, int propertyId,int personalAccountId)
        {
            using (PgSqlConnection conn = new PgSqlConnection(connectionString))
            {
                conn.Open();
                PgSqlCommand pgSqlCommand = new PgSqlCommand("INSERT INTO dynamic_params (personal_account_id, value, period, property_id) " +
                    "VALUES (@personal_account_id, @value, @period, @property_id)"
                    , conn);
                pgSqlCommand.Parameters.Add("@personal_account_id", personalAccountId);
